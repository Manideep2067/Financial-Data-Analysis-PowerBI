...
To compare revenue, profitability, cash flow, assets, and liabilities over time.
...
Income Statement: Revenue, Net Income, Cost of Revenue, Operating Income

Balance Sheet: Total Assets, Total Liabilities, Debt, Equity, Retained Earnings
...
Multiple fact tables (Income, Balance Sheet, Cash Flow)

Shared dimensions such as Company (Stock) and Date/Year
...
Negative free cash flow identification
...
Total liabilities and debt analysis
...
Strong operating cash flow indicates better liquidity and financial stability.

High debt and declining assets highlight potential financial risk.
...
Use slicers to filter by company and year.
